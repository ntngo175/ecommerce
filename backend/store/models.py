...
class Gallery(models.Model):
    ...
    image = models.FileField(upload_to="products", default="product.jpg", null=True, blank=True)
    active = models.BooleanField(default=True)
    gid = ShortUUIDField(max_length = 25, length = 10, alphabet = "abcdefg12345")
...
class Cart(models.Model):
    ...
    shipping_amount = models.DecimalField(default=0.00, decimal_places=2, max_digits=12)
    service_fee = models.DecimalField(default=0.00, decimal_places=2, max_digits=12)
    tax_fee = models.DecimalField(default=0.00, decimal_places=2, max_digits=12)
...
class CartOrder(models.Model):
    ...
    #Coupons
    initial_total = models.DecimalField(default=0.00, decimal_places=2, max_digits=12)
    saved = models.DecimalField(default=0.00, decimal_places=2, max_digits=12)
